...
onready var card_values = {
	...
	7:["skeleton", 3,2,3,2], 8:["scaven", 3,4,5,3], 9:["octoroc", 2,3,2,3],
	10:["wizard", 1,6,1,2], 11:["wasp", 4,4,4,8], 12:["heroine", 5,5,7,8],
	13:["pakkun", 5,6,5,4], 14:["zoomba", 5,5,5,5], 15:["spider", 7,3,5,5],
	16:["atuin", 6,3,6,5], 17:["hero", 6,7,6,6], 18:["ghost", 10,5,5,5],
	19:["seed", 9,9,9,8], 20:["clone", 6,6,6,7], 21:["undead_king", 9,6,5,5],
